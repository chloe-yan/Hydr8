...
class MonthlyBasicBarChart: UIView {
    ...
    private let presenter = MonthlyBasicBarChartPresenter(barWidth: 14.5, space: 8)
    ...
    private var barEntries: [MonthlyBarEntry] = [] {
        didSet {
    ...
    private func showEntry(index: Int, entry: MonthlyBarEntry, animated: Bool, oldEntry: MonthlyBarEntry?) {
